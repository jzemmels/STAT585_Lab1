...
```r
ref(l1, l2)
#> █ [1:0x565488696988] <list> 
#> ├─[2:0x56548b40bbf8] <dbl> 
#> ├─[3:0x56548b40bbc0] <dbl> 
#> └─[4:0x56548b40bb88] <dbl> 
#>  
#> █ [5:0x56548dee26a8] <list> 
#> ├─[2:0x56548b40bbf8] 
#> ├─[3:0x56548b40bbc0] 
#> └─[6:0x56548df1ddf0] <dbl>
```
...
#> █ [1:0x56548aba23d8] <chr> 
#> ├─[2:0x565487d23798] <string: "a"> 
#> ├─[2:0x565487d23798] 
#> ├─[3:0x5654899754e8] <string: "abc"> 
#> └─[4:0x5654881df540] <string: "d">
```
...
ref(e)
#> █ [1:0x5654886dac18] <env> 
#> └─self = [1:0x5654886dac18]
```
...
#> Ncells  677949 36.3    1283188 68.6  1283188 68.6
#> Vcells 4690435 35.8   11785834 90.0 11785654 90.0
```
