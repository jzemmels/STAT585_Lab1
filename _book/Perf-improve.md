...
#> 1 mean1(x)      227µs    236µs     3903.     0
#> 2 mean2(x)      113µs    113µs     8483.     0
```
...
#>   expression           min   median `itr/sec`  n_gc
#>   <chr>           <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)           3.02µs   3.45µs   277813.     0
#> 2 mean.default(x)   1.38µs    1.7µs   537283.     1
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)              3.34µs   4.16µs   203826.     1
#> 2 mean.default(x)       1.4µs   1.65µs   555808.     0
#> 3 .Internal(mean(x)) 365.89ns 381.03ns  2543262.     0
```
...
#>   expression              min   median `itr/sec`  n_gc
#>   <chr>              <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 mean(x)                25µs   27.6µs    34432.     1
#> 2 mean.default(x)      23.4µs   24.8µs    38704.     0
#> 3 .Internal(mean(x))   22.4µs   23.3µs    42400.     0
```
...
#>   expression         min   median `itr/sec`  n_gc
#>   <chr>         <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 as.data.frame   1.28ms   1.44ms      637.     5
#> 2 quick_df        8.05µs   9.19µs   101356.     2
```
...
#>   expression        min   median `itr/sec`  n_gc
#>   <chr>        <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 lookup[x1]   615.95ns 678.93ns  1371261.     0
#> 2 lookup[x10]    1.73µs   2.04µs   434500.     1
#> 3 lookup[x100]   4.56µs   6.38µs   149893.     0
```
...
#>   expression      min   median `itr/sec`  n_gc
#>   <chr>      <bch:tm> <bch:tm>     <dbl> <dbl>
#> 1 loop10      22.94µs  27.14µs    34272.     3
#> 2 loop100    840.55µs 878.85µs     1121.     1
#> 3 vec10        5.14µs   5.65µs   173929.     1
#> 4 vec100      39.93µs  42.09µs    23220.     0
```
