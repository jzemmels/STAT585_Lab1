...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x7f7f9f17ef80>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)       1.42µs   2.21µs   1.55µs  94.24µs   451533.
#> 2 sumC(x)      3.35µs   4.88µs   4.89µs   1.07ms   204735.
#> 3 sumR(x)     60.15µs  67.78µs  63.49µs 143.04µs    14753.
```
...
#>   expression          min     mean   median      max `itr/sec`
#>   <chr>          <bch:tm> <bch:tm> <bch:tm> <bch:tm>     <dbl>
#> 1 pdistR(0.5, y)   7.72ms   8.56ms   8.34ms     11ms     117. 
#> 2 pdistC(0.5, y)  10.66ms  11.58ms  11.28ms     16ms      86.4
```
...
#> 1 gibbs_r(1…   6.01ms   6.99ms   6.82ms 11.49ms      143.    4.97MB    10
#> 2 gibbs_cpp… 277.42µs 331.08µs  323.1µs  1.53ms     3020.     4.1KB     8
...
#> 1 vacc1        2.1ms   2.45ms   2.33ms   4.5ms      409.    7.86KB     8
#> 2 vacc2      105.8µs 137.53µs 122.66µs   275µs     7271.  223.98KB    16
#> 3 vacc3       29.3µs  38.12µs  33.93µs  91.9µs    26232.   14.48KB     4
#> # ... with 2 more variables: n_itr <int>, total_time <bch:tm>
```
