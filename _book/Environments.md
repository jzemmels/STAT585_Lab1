...
#> Error in global_env() == current_env(): comparison (1) is possible only
#> for atomic and list types
```
...
```r
env_parents(e2b)
#> [[1]]   <env: 0x5616f01e1fc8>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0x5616f04bbc28>
#> [[2]] $ <env: empty>
```
